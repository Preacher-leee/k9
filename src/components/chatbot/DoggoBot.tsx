...
const config = {
  initialMessages: [
    createChatBotMessage(
      "Hi! I'm DoggoBot 🐾 I can help you find the perfect dog breed, answer questions about dog care, or find local shelters. What would you like to know?"
    ),
  ],
  botName: 'DoggoBot',
  customStyles: {
    botMessageBox: { backgroundColor: '#2d3e67' },
    chatButton: { backgroundColor: '#f68b28' },
  },
  state: {},
